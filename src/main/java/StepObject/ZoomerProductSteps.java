...
public class ZoomerProductSteps extends ZoomerProductpage {
    @Step("მობილურების გვერდის გახსნა: {mobileBtn}")
    public ZoomerProductSteps MobileBtn() {
        mobileBtn.click();

        return this;
    }
    @Step("ჩამოვხსნათ რომ ავირჩიოთ ფასი ზრდადობით გვინდა თუ კლებადობით: {gamoshBtn}")
    public ZoomerProductSteps GamoshBtn() {
        gamoshBtn.click();

        return this;
    }
    @Step("ფასი ზრდადობით: {sortBtn}")
    ...
    @Step("ფასი კლებადობით: {getSortBtnK}")
    ...
    @Step("ფასი ზრდადობით ფილტრის შემოწმება: {checkfilter}")
    ...
    @Step("ფასი კლებადობით ფილტრის შემოწმება: {checkfilterN}")
    ...
    @Step("შევამოწმოთ პროდუქტის რაოდენობა: {checkCount}")
